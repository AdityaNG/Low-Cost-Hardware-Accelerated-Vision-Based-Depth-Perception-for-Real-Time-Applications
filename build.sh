...
if [ "$#" == "0" ]
	then
		echo "Expected 1 parameter : MODE [ 0-CPU / 1-CUDA / 2-OpenMP / 3-CUDA+OpenMP / 4-CUDA+CUDA]"
		exit 1
fi
...
if [ $1 == "1" ]
	then
		echo "nvcc $2 -o bin/stereo_vision src/stereo_vision.cu src/elas/*.cpp  src/yolo/*.cpp src/graphing/*.cpp -lpopt -lglut -lGLU -lGL -std=c++11 -Xcompiler=\"-pthread\" \`pkg-config --cflags --libs opencv\` -w"
		nvcc $2 -o bin/stereo_vision src/stereo_vision.cu src/elas/*.cpp  src/yolo/*.cpp src/graphing/*.cu -lpopt -lglut -lGLU -lGL -std=c++11 -Xcompiler="-pthread" `pkg-config --cflags --libs opencv` -w && echo "Compiled Successfully!! Run the program using ./bin/stereo_vision -k path_to_kitti -v 1 -p 0 -f 1"
...
if [ $1 == "3" ]
	then
		echo "nvcc $2 -o bin/stereo_vision src/stereo_vision.cu src/elas_openmp/*.cpp  src/yolo/*.cpp src/graphing/*.cpp -lpopt -lglut -lGLU -lGL -std=c++11 -Xcompiler=\"-pthread -fopenmp\" -lm \`pkg-config --cflags --libs opencv\` -w"
		nvcc $2 -o bin/stereo_vision src/stereo_vision.cu src/elas_openmp/*.cpp  src/yolo/*.cpp src/bayesian/*.cpp src/graphing/*.cu -lpopt -lglut -lGLU -lGL -std=c++11 -Xcompiler="-pthread -fopenmp" -lm `pkg-config --cflags --libs opencv` -w && echo "Compiled Successfully!! Run the program using ./bin/stereo_vision -k path_to_kitti -v 1 -p 0 -f 1"
...
if [ $1 == "4" ]
	then
		echo "nvcc $2 -o bin/stereo_vision src/stereo_vision_v1.1.cu src/elas_cuda/*.cpp src/elas_cuda/*.cu  src/yolo/*.cpp src/graphing/*.cpp -lpopt -lglut -lGLU -lGL -std=c++11 -Xcompiler=\"-pthread -fopenmp\" -lm \`pkg-config --cflags --libs opencv\` -w"
		nvcc $2 -o bin/stereo_vision src/stereo_vision_v1.1.cu src/elas_cuda/*.cpp src/elas_cuda/*.cu src/yolo/*.cpp src/bayesian/*.cpp src/graphing/*.cu -lpopt -lglut -lGLU -lGL -std=c++11 -Xcompiler="-pthread -fopenmp" -lm `pkg-config --cflags --libs opencv` -w && echo "Compiled Successfully!! Run the program using ./bin/stereo_vision -k path_to_kitti -v 1 -p 0 -f 1"
...
if [ $1 == "5" ]
	then
		echo "nvcc $2 -o bin/stereo_vision src/stereo_vision_v1.2.cu src/elas_cuda_openmp/*.cpp src/elas_cuda_openmp/*.cu  src/yolo/*.cpp src/graphing/*.cpp -lpopt -lglut -lGLU -lGL -std=c++11 -Xcompiler=\"-pthread -fopenmp\" -lm \`pkg-config --cflags --libs opencv\` -w"
