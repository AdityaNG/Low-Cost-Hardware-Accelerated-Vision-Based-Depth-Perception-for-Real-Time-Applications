...
auto net = cv::dnn::readNetFromDarknet("YOLO/yolov4-tiny0.cfg", "YOLO/yolov4-tiny.weights");
...
void initYOLO() {
    ...
    #net = cv::dnn::readNetFromDarknet("YOLO/yolov4-tiny.cfg", "YOLO/yolov4-tiny.weights");
